...
public class ExtendReportsManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter.config().setDocumentTitle("Guru99 Practice Exercise Report"); // Title of report
		sparkReporter.config().setReportName("Guru99 Practice Functional Testing"); // name of the report
		sparkReporter.config().setTheme(Theme.DARK); // Theeam.standaed -for theam changing

		extent = new ExtentReports();
		extent.attachReporter(sparkReporter);
		extent.setSystemInfo("Application", "Application Exercise");
